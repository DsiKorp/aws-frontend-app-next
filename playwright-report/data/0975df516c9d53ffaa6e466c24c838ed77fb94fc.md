...
- Name: compare-yourself.spec.ts >> Compare Yourself >> redirects unauthenticated users away from /compare
- Location: e2e\compare-yourself.spec.ts:11:7
...
Expected pattern: /\/$/
Received string:  "http://localhost:4200/compare"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × unexpected value "http://localhost:4200/compare"
